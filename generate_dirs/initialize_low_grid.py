...
def create_directories(base_dir="nad_convos_low"):
    ...
    files_to_copy = ["rn", "mk", "clean", "gyre_non-ad.in", "re"]  # Added the "re" file
    ...
    for mass in mass_range:
        for metallicity in metallicity_range:
            ...
            for dir_name in directories_to_copy:
                src_path = os.path.join("./", dir_name)
            ...
            inlist_content = f"""! This is the first inlist file that MESA reads when it starts.
